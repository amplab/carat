...
public class BatteryStatus implements org.apache.thrift.TBase<BatteryStatus, BatteryStatus._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatteryStatus");
  ...
  static {
    schemes.put(StandardScheme.class, new BatteryStatusStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatteryStatusTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatteryStatus.class, metaDataMap);
  }
  ...
  public BatteryStatus setBatteryCharger(String batteryCharger) {
  ...
  public BatteryStatus setBatteryHealth(String batteryHealth) {
  ...
  public BatteryStatus setBatteryVoltage(double batteryVoltage) {
  ...
  public BatteryStatus setBatteryTemperature(double batteryTemperature) {
  ...
  public BatteryStatus setBatteryTechnology(String batteryTechnology) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatteryStatus)
      return this.equals((BatteryStatus)that);
    return false;
  }

  public boolean equals(BatteryStatus that) {
    if (that == null)
      return false;
  ...
  public int compareTo(BatteryStatus other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    BatteryStatus typedOther = (BatteryStatus)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatteryStatus(");
    boolean first = true;
  ...
  private static class BatteryStatusStandardSchemeFactory implements SchemeFactory {
    public BatteryStatusStandardScheme getScheme() {
      return new BatteryStatusStandardScheme();
    }
  }

  private static class BatteryStatusStandardScheme extends StandardScheme<BatteryStatus> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatteryStatus struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatteryStatus struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BatteryStatusTupleSchemeFactory implements SchemeFactory {
    public BatteryStatusTupleScheme getScheme() {
      return new BatteryStatusTupleScheme();
    }
  }

  private static class BatteryStatusTupleScheme extends TupleScheme<BatteryStatus> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatteryStatus struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatteryStatus struct) throws org.apache.thrift.TException {
