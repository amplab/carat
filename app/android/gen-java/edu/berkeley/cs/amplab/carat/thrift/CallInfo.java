...
public class CallInfo implements org.apache.thrift.TBase<CallInfo, CallInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetIncomingCallTime() {
    __isset_bit_vector.clear(__INCOMINGCALLTIME_ISSET_ID);
  }
  ...
  public boolean isSetIncomingCallTime() {
    return __isset_bit_vector.get(__INCOMINGCALLTIME_ISSET_ID);
  }

  public void setIncomingCallTimeIsSet(boolean value) {
    __isset_bit_vector.set(__INCOMINGCALLTIME_ISSET_ID, value);
  }
  ...
  public void unsetOutgoingCallTime() {
    __isset_bit_vector.clear(__OUTGOINGCALLTIME_ISSET_ID);
  }
  ...
  public boolean isSetOutgoingCallTime() {
    return __isset_bit_vector.get(__OUTGOINGCALLTIME_ISSET_ID);
  }

  public void setOutgoingCallTimeIsSet(boolean value) {
    __isset_bit_vector.set(__OUTGOINGCALLTIME_ISSET_ID, value);
  }
  ...
  public int compareTo(CallInfo other) {
    ...
    CallInfo typedOther = (CallInfo)other;

    lastComparison = Boolean.valueOf(isSetIncomingCallTime()).compareTo(typedOther.isSetIncomingCallTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIncomingCallTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.incomingCallTime, typedOther.incomingCallTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetOutgoingCallTime()).compareTo(typedOther.isSetOutgoingCallTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOutgoingCallTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.outgoingCallTime, typedOther.outgoingCallTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNonCallTime()).compareTo(typedOther.isSetNonCallTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNonCallTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nonCallTime, typedOther.nonCallTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCallStatus()).compareTo(typedOther.isSetCallStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callStatus, typedOther.callStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
