...
public class Sample implements org.apache.thrift.TBase<Sample, Sample._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField NETWORK_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("networkStatus", org.apache.thrift.protocol.TType.STRUCT, (short)15);
  private static final org.apache.thrift.protocol.TField BATTERY_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("batteryStatus", org.apache.thrift.protocol.TType.STRUCT, (short)16);
  ...
  public NetworkStatus networkStatus; // optional
  public BatteryStatus batteryStatus; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NETWORK_STATUS((short)15, "networkStatus"),
    BATTERY_STATUS((short)16, "batteryStatus"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 15: // NETWORK_STATUS
          return NETWORK_STATUS;
        case 16: // BATTERY_STATUS
  ...
  private _Fields optionals[] = {_Fields.TIMESTAMP,_Fields.PI_LIST,_Fields.BATTERY_STATE,_Fields.BATTERY_LEVEL,_Fields.MEMORY_WIRED,_Fields.MEMORY_ACTIVE,_Fields.MEMORY_INACTIVE,_Fields.MEMORY_FREE,_Fields.MEMORY_USER,_Fields.TRIGGERED_BY,_Fields.NETWORK_STATUS,_Fields.DISTANCE_TRAVELED,_Fields.SCREEN_BRIGHTNESS,_Fields.NETWORK_STATUS,_Fields.BATTERY_STATUS,_Fields.CPU_STATUS,_Fields.LOCATION_PROVIDERS,_Fields.CALL_INFO};
  ...
  static {
    ...
    tmpMap.put(_Fields.SCREEN_BRIGHTNESS, new org.apache.thrift.meta_data.FieldMetaData("screenBrightness", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.NETWORK_STATUS, new org.apache.thrift.meta_data.FieldMetaData("networkStatus", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, NetworkStatus.class)));
    tmpMap.put(_Fields.BATTERY_STATUS, new org.apache.thrift.meta_data.FieldMetaData("batteryStatus", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BatteryStatus.class)));
  ...
  public Sample(Sample other) {
    ...
    if (other.isSetNetworkStatus()) {
      this.networkStatus = new NetworkStatus(other.networkStatus);
    }
    if (other.isSetBatteryStatus()) {
      this.batteryStatus = new BatteryStatus(other.batteryStatus);
    }
  ...
  public Sample setNetworkStatus(NetworkStatus networkStatus) {
    this.networkStatus = networkStatus;
    return this;
  }
  ...
  public Sample setBatteryStatus(BatteryStatus batteryStatus) {
    this.batteryStatus = batteryStatus;
    return this;
  }

  public void unsetBatteryStatus() {
    this.batteryStatus = null;
  }

  /** Returns true if field batteryStatus is set (has been assigned a value) and false otherwise */
  public boolean isSetBatteryStatus() {
    return this.batteryStatus != null;
  }

  public void setBatteryStatusIsSet(boolean value) {
    if (!value) {
      this.batteryStatus = null;
    }
  }
  ...
  public boolean equals(Sample that) {
    ...
    boolean this_present_batteryStatus = true && this.isSetBatteryStatus();
    boolean that_present_batteryStatus = true && that.isSetBatteryStatus();
    if (this_present_batteryStatus || that_present_batteryStatus) {
      if (!(this_present_batteryStatus && that_present_batteryStatus))
        return false;
      if (!this.batteryStatus.equals(that.batteryStatus))
        return false;
    }
  ...
  public int compareTo(Sample other) {
    ...
    lastComparison = Boolean.valueOf(isSetBatteryStatus()).compareTo(typedOther.isSetBatteryStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBatteryStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.batteryStatus, typedOther.batteryStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCpuStatus()).compareTo(typedOther.isSetCpuStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCpuStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cpuStatus, typedOther.cpuStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetCallInfo()).compareTo(typedOther.isSetCallInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callInfo, typedOther.callInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class SampleStandardScheme extends StandardScheme<Sample> {
        ...
        switch (schemeField.id) {
          ...
          case 15: // NETWORK_STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.networkStatus = new NetworkStatus();
              struct.networkStatus.read(iprot);
              struct.setNetworkStatusIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
          ...
          case 16: // BATTERY_STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.batteryStatus = new BatteryStatus();
              struct.batteryStatus.read(iprot);
              struct.setBatteryStatusIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Sample struct) throws org.apache.thrift.TException {
      ...
      if (struct.networkStatus != null) {
        if (struct.isSetNetworkStatus()) {
          oprot.writeFieldBegin(NETWORK_STATUS_FIELD_DESC);
          struct.networkStatus.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      if (struct.batteryStatus != null) {
        if (struct.isSetBatteryStatus()) {
          oprot.writeFieldBegin(BATTERY_STATUS_FIELD_DESC);
          struct.batteryStatus.write(oprot);
          oprot.writeFieldEnd();
        }
      }
