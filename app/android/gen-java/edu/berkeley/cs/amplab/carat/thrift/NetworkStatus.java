...
public class NetworkStatus implements org.apache.thrift.TBase<NetworkStatus, NetworkStatus._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NetworkStatus");
  ...
  static {
    schemes.put(StandardScheme.class, new NetworkStatusStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NetworkStatusTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.NETWORK_TYPE,_Fields.MOBILE_NETWORK_TYPE,_Fields.MOBILE_DATA_STATUS,_Fields.MOBILE_DATA_ACTIVITY,_Fields.ROAMING_ENABLED,_Fields.WIFI_STATUS,_Fields.WIFI_SIGNAL_STRENGTH,_Fields.WIFI_LINK_SPEED};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NetworkStatus.class, metaDataMap);
  }
  ...
  public NetworkStatus setNetworkType(String networkType) {
  ...
  public NetworkStatus setMobileNetworkType(String mobileNetworkType) {
  ...
  public NetworkStatus setMobileDataStatus(String mobileDataStatus) {
  ...
  public NetworkStatus setMobileDataActivity(String mobileDataActivity) {
  ...
  public NetworkStatus setRoamingEnabled(boolean roamingEnabled) {
  ...
  public NetworkStatus setWifiStatus(String wifiStatus) {
  ...
  public NetworkStatus setWifiSignalStrength(int wifiSignalStrength) {
  ...
  public NetworkStatus setWifiLinkSpeed(int wifiLinkSpeed) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NetworkStatus)
      return this.equals((NetworkStatus)that);
    return false;
  }

  public boolean equals(NetworkStatus that) {
    if (that == null)
      return false;
  ...
  public int compareTo(NetworkStatus other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    NetworkStatus typedOther = (NetworkStatus)other;
    ...
    lastComparison = Boolean.valueOf(isSetWifiStatus()).compareTo(typedOther.isSetWifiStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWifiStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wifiStatus, typedOther.wifiStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class NetworkStatusStandardSchemeFactory implements SchemeFactory {
    public NetworkStatusStandardScheme getScheme() {
      return new NetworkStatusStandardScheme();
    }
  }

  private static class NetworkStatusStandardScheme extends StandardScheme<NetworkStatus> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NetworkStatus struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NetworkStatus struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NetworkStatusTupleSchemeFactory implements SchemeFactory {
    public NetworkStatusTupleScheme getScheme() {
      return new NetworkStatusTupleScheme();
    }
  }

  private static class NetworkStatusTupleScheme extends TupleScheme<NetworkStatus> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NetworkStatus struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NetworkStatus struct) throws org.apache.thrift.TException {
