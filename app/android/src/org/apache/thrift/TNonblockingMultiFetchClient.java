...
public class TNonblockingMultiFetchClient {
  ...
  public synchronized ByteBuffer[] fetch() {
    ...
    try {
      ...
      task.cancel(true);
      Log.e("Thrift", "interrupted during fetch: "+ie.toString());
    } catch(ExecutionException ee) {
      // attempt to cancel execution of the task.
      task.cancel(true);
      Log.e("Thrift", "exception during fetch: "+ee.toString());
    } catch(TimeoutException te) {
      // attempt to cancel execution of the task.  
      task.cancel(true);
      Log.e("Thrift", "timeout for fetch: "+te.toString());
    }
  ...
  private class MultiFetch implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        Log.e("Thrift", "selector opens error: "+e.toString());
        return;
      }
      ...
      while (stats.getNumReadCompletedServers() +
        ...
        try{
          ...
          Log.e("Thrift", "selector selects error: "+e.toString());
          continue;
        }
    ...
    public void close() {
      try {
        ...
        Log.e("Thrift", "free resource error: "+e.toString());
      }
    }
  }
}