...
public class HogsBugs implements org.apache.thrift.TBase<HogsBugs, HogsBugs._Fields>, java.io.Serializable, Cloneable {
  ...
  public HogsBugs(HogsBugs other) {
    ...
    if (other.isSetXValsWithout()) {
      List<Double> __this__xValsWithout = new ArrayList<Double>();
      for (Double other_element : other.xValsWithout) {
        __this__xValsWithout.add(other_element);
      }
      this.xValsWithout = __this__xValsWithout;
    }
    if (other.isSetYValsWithout()) {
      List<Double> __this__yValsWithout = new ArrayList<Double>();
      for (Double other_element : other.yValsWithout) {
        __this__yValsWithout.add(other_element);
      }
  ...
  public void unsetExpectedValueWithout() {
    __isset_bit_vector.clear(__EXPECTEDVALUEWITHOUT_ISSET_ID);
  }
  ...
  public boolean isSetExpectedValueWithout() {
    return __isset_bit_vector.get(__EXPECTEDVALUEWITHOUT_ISSET_ID);
  }
  ...
  public int compareTo(HogsBugs other) {
    ...
    HogsBugs typedOther = (HogsBugs)other;
    ...
    lastComparison = Boolean.valueOf(isSetWDistance()).compareTo(typedOther.isSetWDistance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWDistance()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wDistance, typedOther.wDistance);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetXValsWithout()).compareTo(typedOther.isSetXValsWithout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetXValsWithout()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.xValsWithout, typedOther.xValsWithout);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetYValsWithout()).compareTo(typedOther.isSetYValsWithout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetYValsWithout()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.yValsWithout, typedOther.yValsWithout);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetExpectedValueWithout()).compareTo(typedOther.isSetExpectedValueWithout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpectedValueWithout()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.expectedValueWithout, typedOther.expectedValueWithout);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
