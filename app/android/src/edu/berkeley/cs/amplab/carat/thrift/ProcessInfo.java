...
public class ProcessInfo implements org.apache.thrift.TBase<ProcessInfo, ProcessInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ProcessInfo> {
  ...
  private static final org.apache.thrift.protocol.TField TRAFFIC_RECORD_FIELD_DESC = new org.apache.thrift.protocol.TField("trafficRecord", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  ...
  public TrafficRecord trafficRecord; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TRAFFIC_RECORD((short)10, "trafficRecord");
  ...
  private static final _Fields optionals[] = {_Fields.P_ID,_Fields.P_NAME,_Fields.APPLICATION_LABEL,_Fields.IS_SYSTEM_APP,_Fields.IMPORTANCE,_Fields.VERSION_NAME,_Fields.VERSION_CODE,_Fields.APP_SIGNATURES,_Fields.INSTALLATION_PKG,_Fields.TRAFFIC_RECORD};
  ...
  static {
    ...
    tmpMap.put(_Fields.INSTALLATION_PKG, new org.apache.thrift.meta_data.FieldMetaData("installationPkg", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TRAFFIC_RECORD, new org.apache.thrift.meta_data.FieldMetaData("trafficRecord", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TrafficRecord.class)));
  ...
  public ProcessInfo(ProcessInfo other) {
    ...
    if (other.isSetTrafficRecord()) {
      this.trafficRecord = new TrafficRecord(other.trafficRecord);
    }
  }
  ...
  public ProcessInfo setTrafficRecord(TrafficRecord trafficRecord) {
    this.trafficRecord = trafficRecord;
    return this;
  }

  public void unsetTrafficRecord() {
    this.trafficRecord = null;
  }

  /** Returns true if field trafficRecord is set (has been assigned a value) and false otherwise */
  public boolean isSetTrafficRecord() {
    return this.trafficRecord != null;
  }

  public void setTrafficRecordIsSet(boolean value) {
    if (!value) {
      this.trafficRecord = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TRAFFIC_RECORD:
      if (value == null) {
        ...
        setTrafficRecord((TrafficRecord)value);
      }
      break;
  ...
  public boolean equals(ProcessInfo that) {
    ...
    boolean this_present_trafficRecord = true && this.isSetTrafficRecord();
    boolean that_present_trafficRecord = true && that.isSetTrafficRecord();
    if (this_present_trafficRecord || that_present_trafficRecord) {
      if (!(this_present_trafficRecord && that_present_trafficRecord))
        return false;
      if (!this.trafficRecord.equals(that.trafficRecord))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_trafficRecord = true && (isSetTrafficRecord());
    list.add(present_trafficRecord);
    if (present_trafficRecord)
  ...
  public int compareTo(ProcessInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetTrafficRecord()).compareTo(other.isSetTrafficRecord());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTrafficRecord()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.trafficRecord, other.trafficRecord);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetTrafficRecord()) {
      if (!first) sb.append(", ");
      sb.append("trafficRecord:");
      if (this.trafficRecord == null) {
        sb.append("null");
      } else {
        sb.append(this.trafficRecord);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class ProcessInfoStandardScheme extends StandardScheme<ProcessInfo> {
        ...
        switch (schemeField.id) {
          ...
          case 10: // TRAFFIC_RECORD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.trafficRecord = new TrafficRecord();
              struct.trafficRecord.read(iprot);
              struct.setTrafficRecordIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProcessInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.trafficRecord != null) {
        if (struct.isSetTrafficRecord()) {
          oprot.writeFieldBegin(TRAFFIC_RECORD_FIELD_DESC);
          struct.trafficRecord.write(oprot);
          oprot.writeFieldEnd();
        }
      }
