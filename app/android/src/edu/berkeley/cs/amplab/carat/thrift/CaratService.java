        ...
        return new AsyncMethodCallback<Boolean>() { 
          public void onComplete(Boolean o) {
            ...
            try {
              ...
              Log.e("Protocol", "Exception writing to internal frame buffer", e);
            }
            fb.close();
          }
          public void onError(Exception e) {
            ...
            try {
              ...
              Log.e("Protocol", "Exception writing to internal frame buffer", ex);
            }
            fb.close();
          }
        };
        ...
        if (incoming.get(1)) {
          {
            ...
            {
              Feature _elem103;
              _elem103 = new Feature();
              _elem103.read(iprot);
              struct.features.add(_elem103);
            }
          }
          struct.setFeaturesIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  for (int _i105 = 0; _i105 < _list104.size; ++_i105)
                  {
                    ...
                    struct.processList.add(_elem106);
                  }
                  iprot.readListEnd();
                }
        ...
        if (incoming.get(1)) {
          {
            ...
            for (int _i110 = 0; _i110 < _list109.size; ++_i110)
            {
              ...
              struct.processList.add(_elem111);
            }
          }
          struct.setProcessListIsSet(true);
        }
